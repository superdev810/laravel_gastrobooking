...
<form action="">
    <table>
        ...
        <tr>
            <td>
                <p style="font-size: 18px; margin-top: 0; font-weight: bold; text-decoration: underline;">{{$invoiceSetting->supplier_label}}</p>
        ...
        <tr>
            <td>
                <table>
                    <tr>
                        <td style="border: none;"><span style="font-size: 18px; font-weight: bold;margin-top: 0; text-decoration: underline;">{{$invoiceSetting->bank_label}}</span></td>
                    </tr>
                    <tr>
                        <td style="border: none;"><span>{{$invoiceSetting->bank_name}}</span></td>
                    </tr>
                    <tr>
                        <td style="border: none;"><span style="font-size: 18px; font-weight: bold; text-decoration: underline;">{{$invoiceSetting->ac_number_label}}</span></td>
                    </tr>
                    <tr>
                        <td style="border: none;"><span style="font-size: 18px;">{{$invoiceSetting->ac_number}}</span></td>
                    </tr>
                </table>
                {{--<p style="font-size: 22px; font-weight: bold;margin-top: 0; text-decoration: underline;">{{$invoiceSetting->bank_label}}</p>--}}
                {{--<p>{{$invoiceSetting->bank_name}}</p>--}}
                {{--<p style="font-size: 22px; font-weight: bold; text-decoration: underline;">{{$invoiceSetting->ac_number_label}}</p>--}}
                {{--<p style="font-size: 20px;">{{$invoiceSetting->ac_number}}</p>--}}
            </td>
            <td>
                <table>
                    <tr>
                        <td colspan="4" style="border: none;"><span style="font-size: 18px; font-weight: bold;margin-top: 0; text-decoration: underline;">{{$invoiceSetting->recipient_label}}</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border: none;">{{$invoiceSetting->CN_label}}</td>
                        <td style="border: none;">{{$invoice->restaurant->company_number}}</td>
                        <td style="border: none;">{{$invoiceSetting->VATNo_label}}</td>
                        <td style="border: none;">{{$invoice->restaurant->company_tax_number}}</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <label style="display: block;font-size: 18px;margin:10px 0 10px 0; font-weight: bold; text-decoration: underline;" >{{$invoiceSetting->subject_text_label}}</label>
                ...
                <div style="margin:10px 0 10px 0;">
                    ...
                    <span>{{$invoice->invoice_value * 100 / (100 + $invoice->VAT)}}</span>
                ...
                <div style="margin-bottom:5px;">
                    ...
                    <span style="font-weight: bold"> CZK</span>
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <div style="margin:10px 0 15px 0;">
                    ...
                    <span>{{$invoice->payments[0]->amount}}</span>
